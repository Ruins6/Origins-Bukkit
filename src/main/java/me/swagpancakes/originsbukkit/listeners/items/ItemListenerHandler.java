...
public class ItemListenerHandler {
    ...
    private OriginBallListener originBallListener;
     ...
     */
    public OriginBallListener getOriginBallListener() {
        return originBallListener;
    }
     ...
     */
    private void init() {
        originBallListener = new OriginBallListener(this);
    }
}
