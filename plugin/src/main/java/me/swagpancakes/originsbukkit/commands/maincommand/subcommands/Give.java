            ...
            if (sender.hasPermission(Permissions.GIVE.toString())) {
                if (args.length == 1) {
                    ...
                    if (target != null) {
                        ...
                        switch (item) {
                            case "minecraft:orb_of_origin":
                            case "orb_of_origin":
                                target.getInventory().addItem(getMainCommand().getCommandHandler().getPlugin().getItemHandler().getOrbOfOrigin().getItemStack());
                                break;
                        }
                    } else {
                    ...
                    if (target != null) {
                        ...
                        try {
                            ...
                            switch (item) {
                                case "minecraft:orb_of_origin":
                                case "orb_of_origin":
                                    getMainCommand().getCommandHandler().getPlugin().getItemHandler().getOrbOfOrigin().getItemStack().setAmount(amount);
                                    target.getInventory().addItem(getMainCommand().getCommandHandler().getPlugin().getItemHandler().getOrbOfOrigin().getItemStack());
                                    getMainCommand().getCommandHandler().getPlugin().getItemHandler().getOrbOfOrigin().getItemStack().setAmount(1);
                                    break;
                            }
